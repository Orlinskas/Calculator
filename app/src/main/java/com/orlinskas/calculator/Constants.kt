...
fun getDefaultSceleton(): CalculatorResultModel {
    val products = listOf(
        Product(4, "https://icma.com.ua/storage/calculator-data/products/5250.jpg", "Євроконус Icma 16х2 3/4\" №101", "62.00", "5250", "248.00"),
        Product(107, "https://icma.com.ua/storage/calculator-data/products/5250.jpg","Труба GOLD-PEX Icma 16х2мм 200 м №P198", "25.00", "5306", "2675.00"),
        Product(1, "https://icma.com.ua/storage/calculator-data/products/5250.jpg","Насос Grundfos Icma 25/40-60 №P326", "3792.00", "15560", "3792.00"),
        Product(14, "https://icma.com.ua/storage/calculator-data/products/5250.jpg","Демпферна стрічка 8 мм (50м.п.)", "4.00", "8836", "400.00"),
        Product(1, "https://icma.com.ua/storage/calculator-data/products/5250.jpg","Шафа колекторна 480x580х110 (внутрішній) №1 \"Україна\"", "525.00", "15371", "525.00")
    )
